...
public class EmailServiceImpl implements EmailService {
    ...
    public EmailServiceImpl(JavaMailSender javaMailSender, ModelMapper modelMapper, EmailRepository emailRepo, ContactRepository contactRepo, LeadRepository leadRepo) {
